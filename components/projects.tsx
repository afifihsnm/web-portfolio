      ...
      {projects.map(project => (
        <li key={project.slug} className='group relative'>
          ...
          <a href={`${project.slug}`}>
            ...
            <div className='absolute inset-0 bottom-0 translate-y-2 px-6 py-5 opacity-0 transition-all duration-500 group-hover:translate-y-0 group-hover:opacity-100'>
